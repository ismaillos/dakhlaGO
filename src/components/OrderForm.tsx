...
export default function OrderForm({ product }: OrderFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.nom || !formData.telephone || !formData.adresse || !formData.ville) return;
  ...
  if (status === 'success') {
    return (
      <div className="bg-[#141414] gold-border rounded-2xl p-6 text-center">
        ...
        <h3 className="text-lg font-bold mb-2 text-white">Commande enregistree !</h3>
        <p className="text-white/50 text-sm mb-4">
          Merci <strong className="text-[#E8732F]">{formData.nom}</strong>, votre commande est bien recue.
        </p>
        ...
        <div className="bg-[#0a0a0a] rounded-xl p-4 text-left space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white/70 text-xs font-semibold">Commande recue</p>
              <p className="text-white/40 text-[10px]">Enregistree dans notre systeme</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-white/40 text-[10px]">Sur votre numero : <strong className="text-white/60">{formData.telephone}</strong></p>
            </div>
          </div>
          <div className="flex items-start gap-3">
      ...
      <div className="p-5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            {/* Nom */}
            <div>
              <label className="text-[10px] text-[#E8732F] uppercase tracking-wider font-bold mb-1.5 block flex items-center gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-3.5 py-3 text-[13px] text-white placeholder:text-white/20 focus:border-[#E8732F] focus:ring-1 focus:ring-[#E8732F]/30 focus:outline-none transition-all"
                />
              </div>
            </div>
            {/* Telephone */}
          ...
          <div className="mb-3">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Rue, quartier, numero d'immeuble, etage..."
                required
                className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-3.5 py-3 text-[13px] text-white placeholder:text-white/20 focus:border-[#E8732F] focus:ring-1 focus:ring-[#E8732F]/30 focus:outline-none transition-all"
              />
            </div>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Casablanca, Rabat, Marrakech, Fes..."
                required
                className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-3.5 py-3 text-[13px] text-white placeholder:text-white/20 focus:border-[#E8732F] focus:ring-1 focus:ring-[#E8732F]/30 focus:outline-none transition-all"
              />
            </div>
          ...
          <div className="bg-white/[0.02] rounded-2xl p-4 mb-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                <div className="text-white/30 text-[10px] uppercase tracking-wider font-semibold mb-0.5">Total a payer</div>
          ...
          <div className="bg-[#E8732F]/5 border border-[#E8732F]/15 rounded-xl p-3 text-center">
            <p className="text-white/40 text-[10px] leading-relaxed">
              Notre service client vous contactera sous <strong className="text-[#E8732F]">24 heures</strong> par telephone ou WhatsApp pour confirmer votre commande.
            </p>
          </div>
        </form>
      </div>
