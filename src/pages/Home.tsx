      ...
      <div className="max-w-[1200px] mx-auto px-5 relative z-10 w-full grid md:grid-cols-2 gap-12 items-center pb-16 pt-8">
        <div>
          ...
          <div className="flex gap-3 flex-wrap mb-10">
            <button onClick={() => document.getElementById('produits')?.scrollIntoView({ behavior: 'smooth' })} className="bg-[#E8732F] text-white px-8 py-4 rounded-full text-[13px] font-bold hover:bg-[#c45e22] transition-all duration-200 shadow-[0_8px_32px_rgba(196,98,45,0.30)] hover:shadow-[0_12px_40px_rgba(196,98,45,0.45)] hover:-translate-y-0.5">
              {t.hero.cta1}
            </button>
    ...
    <section className="py-20 px-5 bg-[#1A1208]">
      <div className="max-w-[1200px] mx-auto">
        <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
          ...
          <button onClick={() => document.getElementById('produits')?.scrollIntoView({ behavior: 'smooth' })} className="text-[#F0C060] text-[13px] hover:text-[#E8732F] transition-colors font-medium">
    ...
    <section id="contact" className="py-24 px-5 text-center bg-[#261A08] relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <button onClick={() => document.getElementById('produits')?.scrollIntoView({ behavior: 'smooth' })} className="inline-flex items-center gap-2 border border-[#F0C060]/40 text-white/60 px-8 py-4 rounded-full text-sm font-semibold hover:border-[#D4A574] hover:text-white transition-colors">Voir les produits</button>
        </div>
      </div>
    </section>
  );
